...
+ (NSDictionary *)RCTFormatLocalNotification:(UILocalNotification *)notification
{
    ...
    formattedLocalNotification[@"title"] = RCTNullIfNil(notification.alertTitle);
    formattedLocalNotification[@"body"] = RCTNullIfNil(notification.alertBody);
    formattedLocalNotification[@"badge"] = @(notification.applicationIconBadgeNumber);
    formattedLocalNotification[@"category"] = RCTNullIfNil(notification.category);
    formattedLocalNotification[@"sound"] = RCTNullIfNil(notification.soundName);
